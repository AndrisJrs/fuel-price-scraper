...
class GasStations:
    ...
    fuel_renewable_diesel_key = 'fuel_renewable_diesel_price'
    ...
    def get_circlek_prices() -> list:
        ...
        fuel_95_price_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2)'
        fuel_95_location_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(3)'
        fuel_98_price_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(2)'
        fuel_98_location_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(3)'
        fuel_diesel_price_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(3) > td:nth-child(2)'
        fuel_diesel_location_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(3) > td:nth-child(3)'
        fuel_renewable_diesel_price_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(5) > td:nth-child(2)'
        fuel_renewable_diesel_location_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(5) > td:nth-child(3)'
        fuel_lpg_price_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(6) > td:nth-child(2)'
        fuel_lpg_location_css_selector = '.table > tbody:nth-child(2) > tr:nth-child(6) > td:nth-child(3)'
        ...
        fuel_renewable_diesel_price = GasStations.__get_fuel_price(response.text, station_name, fuel_renewable_diesel_price_css_selector, fuel_renewable_diesel_location_css_selector, GasStations.fuel_renewable_diesel_key)
        fuel_prices.append(fuel_renewable_diesel_price)
    ...
    def get_neste_prices() -> list:
        ...
        fuel_95_location_css_selector = '.field__item > table:nth-child(4) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3) > p:nth-child(1) > span:nth-child(1)'
        ...
        fuel_98_location_css_selector = '.field__item > table:nth-child(4) > tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(3) > span:nth-child(1)'
        ...
        fuel_diesel_location_css_selector = '.field__item > table:nth-child(4) > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(3) > span:nth-child(1)'
